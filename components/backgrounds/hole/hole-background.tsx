  ...
  return (
    <div
      className={cn(
        ...
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] before:bg-black before:[transform:translate3d(-50%,-50%,0)]',
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#FF6B00_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          ...
          "dark:[background:linear-gradient(20deg,#FFD700,#FF6B00_16.5%,#FF1744_33%,#FF6B00_49.5%,#FFD700_66%,#FFA500_85.5%,#FF4500_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#FFD700,#FF6B00_16.5%,#FF1744_33%,#FF6B00_49.5%,#FFD700_66%,#FFA500_85.5%,#FF4500_100%)_0_100%_/_100%_200%]",
        )}
